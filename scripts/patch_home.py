...
# Update already-patched metadata on subsequent deployments.
...
if '.identity-label{' not in s:
    ...
    end = s.find('}', s.find('.identity-label:after{')) + 1
...
print('Homepage patched for Saudi nationality, academic title, Impact, CV links and social metadata.')
