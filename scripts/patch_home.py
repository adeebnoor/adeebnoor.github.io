...
# Preserve the approved image-based homepage and add precise live overlays.
...
# HEALTHx opens the new English project page.
s = s.replace('href="ventures.html#healthx" aria-label="Explore HEALTHx"', 'href="healthx/" aria-label="Explore HEALTHx"')

# Impact opens the expanded Impact/CV area.
...
# Formal accessibility labels on legacy hotspots.
s = s.replace('aria-label="Let\'s Connect"', 'aria-label="Professional Inquiries"')

p.write_text(s, encoding='utf-8')
print('Homepage finalized: Research-first navigation, About last, Professional Inquiries CTA, Saudi identity, 18+ years, HEALTHx project link.')
