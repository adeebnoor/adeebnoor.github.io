...
for script in ('localize_site.py', 'build_featured_projects.py',
               'build_homepage_positioning.py', 'build_ideas.py', 'build_analytics.py', 'sync_identity.py', 'build_social_cards.py', 'build_audit.py', 'build_thought_leadership.py', 'build_audience_pages.py', 'finalize_public_identity.py'):
