...
def engagement_field(arabic=False):
    if arabic:
        return '<div class="audit-field"><label for="inquiry-engagement">ما نوع الطلب؟</label><select id="inquiry-engagement" name="engagement" required><option value="">اختر نوع الطلب</option><option value="advisory">استشارة أو تكليف قيادي</option><option value="board">مجلس إدارة / لجنة خبراء</option><option value="venture">تمويل / استثمار</option><option value="other">إشراف</option><option value="speaking">محاضرة / كلمة / ورشة</option><option value="research">شراكة / تعاون</option></select></div>'
    return '<div class="audit-field"><label for="inquiry-engagement">What is this request about?</label><select id="inquiry-engagement" name="engagement" required><option value="">Please select</option><option value="advisory">Advisory or leadership engagement</option><option value="board">Board / expert committee</option><option value="venture">Funding / investment</option><option value="other">Student supervision</option><option value="speaking">Lecture / keynote / workshop</option><option value="research">Partnership / collaboration</option></select></div>'
