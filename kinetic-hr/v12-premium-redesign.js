...
function renderScenarioKpis(){
  ...
  <article class="v12-skpi"><div class="v12-skpi-icon">◉</div><div><span>${L('نقص القدرة الحالي','Current gap')}</span><strong>${fmt(deficit(r),1)} ${KHPlain.unit()}</strong><small>${esc(occupationLabel(r.ssco))}</small></div></article>
